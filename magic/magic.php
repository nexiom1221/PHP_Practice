...
{
	echo "당신의 숫자는 ".$input_value."입니다.<br /><br />";
	
	
	echo "<button id=\"btnfun2\" name=\"btnfun2\" onClick='location.href=\"magic.html?val=6".($current_value+0)."\"'>다시하기</button>";
